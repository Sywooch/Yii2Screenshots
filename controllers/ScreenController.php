...
class ScreenController extends \yii\web\Controller
{
    ...
    {
        \Yii::$app->opengraph->title = \Yii::$app->name;
        \Yii::$app->opengraph->description = 'Einfaches Hochladen und Teilen von Bildern innerhalb weniger Sekunden. Ein Service von Kellerkind24';
    ...
    public function actionShow($id)
    {
        ...
        \Yii::$app->opengraph->image = '/d/'.$image->file_id;
